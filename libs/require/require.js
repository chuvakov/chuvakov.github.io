						...
						if (this.inited) {
							if (this.error) this.emit('error', this.error);
								...
								if (((this.defining = !0), this.depCount < 1 && !this.defined)) {
									...
									if (
										((this.exports = n),
										this.map.isDefine && !this.ignore && ((j[i] = n), req.onResourceLoad))
									) {
										var a = [];
			...
			(q = {
				...
				makeShimExports: function (e) {
					return function () {
						var t;
						return (
							e.init && (t = e.init.apply(global, arguments)), t || (e.exports && getGlobal(e.exports))
						);
					};
				},
				...
				nameToUrl: function (e, t, i) {
					...
					if (req.jsExtRegExp.test(e)) s = e + (t || '');
						...
						(s = n.join('/')),
							(s =
								('/' === (s += t || (/^data\:|^blob\:|\?/.test(s) || i ? '' : '.js')).charAt(0) ||
								s.match(/^[\w\+\.\-]+:/)
									? ''
									: y.baseUrl) + s);
					}
